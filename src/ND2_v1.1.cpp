...
{    
    ...
    if (arClass) {
        ...
        std::cout << "Ar norite generuoti studento failus automatiskai ir is ju skaityti duomenis, ar duomenu negeneruoti? (0 - negeneruoti, 1 - generuoti): ";
            ...
            if (arFailas) { // skaitomi is failo
                ...
                if (infile.is_open()) { // paprastuju failu nuskaitymas
                    ...
                    try {
                        ...
                        std::cout << "Ivyko klaida failo pirmos eilutes nuskaityme. \n";
                    }
                    ...
                    while (!infile.eof()) {
                        try {
                            ...
                            std::cout << "Klaida nuskaitant failo duomenis\n";
                        }
                ...
                if (arMediana) {
                    std::cout << "Pavarde:            Vardas:             Galutinis ivert.:\n";
                    std::cout << "---------------------------------------------------------\n";
                    std::cout << left << setw(20) << studentas.pavarde << setw(20) << studentas.vardas << setw(20) << fixed << setprecision(2) << studentas.galMed << endl;
                }
                else {
                    std::cout << "Pavarde:            Vardas:             Galutinis ivert.:\n";
                    std::cout << "---------------------------------------------------------\n";
                    std::cout << left << setw(20) << studentas.pavarde << setw(20) << studentas.vardas << setw(20) << fixed << setprecision(2) << studentas.galVid << endl;
                }
